<div id="menu" class="animate__animated animate__fadeIn">
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <div class="offcanvas offcanvas-start" id="navbarSupportedContent">
            ...
            <div style="padding-right:10%" class="col-lg-12">
                <div class="offcanvas-body">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex justify-content-end">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#">Financial Solution</a>
                        </li>
                        <li class="nav-item">
